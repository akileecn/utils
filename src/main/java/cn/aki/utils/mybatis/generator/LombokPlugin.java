...
public class LombokPlugin extends PluginAdapter {
    ...
    private void addAnnotations(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        // 类注解
        createClassComment(topLevelClass);
        // 序列化
    ...
    public boolean clientGenerated(
        ...
        FullyQualifiedJavaType topLevelClassType = new FullyQualifiedJavaType(introspectedTable.getBaseRecordType());
        interfaze.addImportedType(topLevelClassType);
        interfaze.addSuperInterface(new FullyQualifiedJavaType(
                "Mapper<" + topLevelClassType.getShortName() + ">"));
        // 类注解
        createClassComment(interfaze);
        return true;
    }
    ...
    private enum Annotations {
        ...
        private static Collection<Annotations> getDependencies(Annotations annotation) {
            switch (annotation) {
                ...
                case BUILDER:
                    return Arrays.asList(ALL_ARGS_CONSTRUCTOR, NO_ARGS_CONSTRUCTOR);
                default:
